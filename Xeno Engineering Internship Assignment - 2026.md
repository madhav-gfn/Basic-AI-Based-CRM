...
| :- | :- |
|<p>Build & deploy (table </p><p>stakes)</p>|A live, hosted, working product with a walkthrough video. This is the baseline expectation, not a differentiator — you stand out on everything below.|
...
|**What we evaluate** |**What we're looking for**|
| :- | :- |
|AI-native development |How well you leveraged AI to build. We want to see an AI-native workflow — how you direct, review, and integrate AI output, not whether you used it.|
|Code quality & structure |Clean, readable, well-organised code with sensible structure. We will read your code and ask about it.|
...
|<p>Thought clarity & </p><p>communication</p>|How clearly you think, present, and explain — in your video and in your decisions.|
...
|**Section** |**Suggested time**|**What to cover**|
| :- | :- | :- |
...
|AI-native workflow |~1 min |How you leveraged AI while building — how AI-native your dev workflow was.|
